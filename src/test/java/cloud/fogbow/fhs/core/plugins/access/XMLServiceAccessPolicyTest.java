...
public class XMLServiceAccessPolicyTest {
    ...
    private XMLServiceAccessPolicy accessPolicy;
    ...
    @Before
    public void setUp() {
        String policyStringStart = "<?xml version=\"1.0\"?>" + 
                "<policy>";
        String policyStringEnd = "</policy>";
        
        this.accessLevelString1 = 
                "<accesslevel>" +
                "<name>" + ACCESS_LEVEL_1_NAME + "</name>" +
            
                "<operations>" +
                "<operation>" +
                "<method>" + GET_METHOD_STRING + "</method>" +
                "<path>" + PATH_OPERATION + "</path>" +
                "</operation>" +
                
                "<operation>" +
                "<method>" + POST_METHOD_STRING + "</method>" +
                "<path>" + PATH_OPERATION + "</path>" +
                "</operation>" +
                "</operations>" +
                ...
                "<clouds>" +
                "<cloud>" +
                "<name>" + CLOUD_NAME_1 + "</name>" +
                "<credentials>" +
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_1 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_1 + "</value>" +
                "</credential>" +
                        
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_2 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_2 + "</value>" +
                "</credential>" +
                "</credentials>" +
                "</cloud>" +
                
                "<cloud>" +
                "<name>" + CLOUD_NAME_2 + "</name>" +
                "<credentials>" +
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_3 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_3 + "</value>" +
                "</credential>" +
                        
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_4 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_4 + "</value>" +
                "</credential>" +
                "</credentials>" +
                "</cloud>" +
        ...
        this.accessLevelString2 = 
                ...
                "<attributes>" +
                "<attribute>" + ATTRIBUTE_0 + "</attribute>" +
                "</attributes>" +
                ...
                "<credentials>" +
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_5 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_5 + "</value>" +
                "</credential>" +
                        
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_6 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_6 + "</value>" +
                "</credential>" +
                "</credentials>" +
                "</cloud>" +
                ...
                "<credentials>" +
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_7 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_7 + "</value>" +
                "</credential>" +
                        
                "<credential>" +
                "<key>" + CREDENTIAL_NAME_8 + "</key>" +
                "<value>" + CREDENTIAL_VALUE_8 + "</value>" +
                "</credential>" +
                "</credentials>" +
                "</cloud>" +
        ...
        this.accessLevelString = policyStringStart + this.accessLevelString1 + this.accessLevelString2 + policyStringEnd;
    ...
    public void testConstructor() throws ConfigurationErrorException {
        this.accessPolicy = new XMLServiceAccessPolicy(accessLevelString);
    ...
    @Test
    public void testIsAllowedToPerform() throws ConfigurationErrorException {
        this.accessPolicy = new XMLServiceAccessPolicy(accessLevelString);
    ...
    @Test
    public void testGetCredentialsForAccess() throws ConfigurationErrorException {
        this.accessPolicy = new XMLServiceAccessPolicy(accessLevelString);
